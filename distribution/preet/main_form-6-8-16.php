...
<form method="post"  action="process_form.php" name="frm_enquiry" id="frm_enquiry"  enctype="multipart/form-data" onsubmit="return checkfiles();" >
        ...
        <input name="website_url[]" id="website_url0" type="text" class="car-field1" value=""  style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">	
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url" id="website_url1" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
        <label class="blocklabe2">Last 1st Year ITR</label>
		 <input type="file" name="userfile[]" style="padding-top:10px;">
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url[]" id="website_url2" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
        <label class="blocklabe2">Last 1st Year ITR</label>
		 <input type="file" name="userfile[]" style="padding-top:10px;">
    ...
    <div class="red box" style="display:block;">
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url[]" id="website_url3" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
        <label class="blocklabe2">Last 1st Year ITR</label>
		 <input type="file" name="userfile[]" style="padding-top:10px;">
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url[]" id="website_url4" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
        <label class="blocklabe2">Last 1st Year ITR</label>
		 <input type="file" name="userfile[]" style="padding-top:10px;">
    ...
    <div class="red box" style="display:block;">
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url[]" id="website_url5" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
        <label class="blocklabe2">Last 1st Year ITR</label>
		 <input type="file" name="userfile[]" style="padding-top:10px;">
        ...
        <div style="padding-bottom:10px;">
        <label class="blocklabe2">Website Url</label>
        <input name="website_url[]" id="website_url6" type="text" class="car-field1" value="" style="width:200px;">
		</div>
		<div style="padding-bottom:10px;">
