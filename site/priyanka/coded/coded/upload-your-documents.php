...
function addmoreotherLOan(divName){
	 ...
	 // alert(loan_div);
		$('#loan_row_container').append(loan_div);
...
function addmoreotherCard(divName){
	 ...
	 // alert(loan_div);
		$('#card_row_container').append(loan_div);      
   }
...
<div class="form-div">
	...
	<form method="post" action="process_form.php" name="frm_enquiry" id="frm_enquiry"  enctype="multipart/form-data" onSubmit="return Checkfiles();" >
        ...
        <input name="name" id="name" type="text" class="car-field1" value=""  />
        </div>
		<div class="form-div">
        <label for="name" class="blocklabel">Mobile No</label>
        <input  name="mobilechk" id="mobilechk" type="text" class="car-field1" value=""  />
		</div>
		<div class="form-div">
        <label for="name" class="blocklabel">Email id</label>
        <input name="email" id="email"  type="text" class="car-field1" value=""/>
		</div>
		<div class="form-div">
	...
	<table width="100%">
		...
		<tbody>
			<tr id="first_loan_row">
			  ...
			  <td align="center"><input type="text" class="car-field1 datepicker" name="startdate[]" data-validation="date" data-validation-format="dd/mm/yyyy" /></td>
...
<div id="card_row" style="display: none;">
  ...
  <div id="loan_row" style="display: none;">
	  ...
	  <td align="center"><input name="loan_emi[]" id='loan_emi' type="text" class="car-field1" style="width:80px;"></td>
	  <td align="center"><input name="loan_rate_int[]" id='loan_rate_int' type="text" class="car-field1" style="width:50px;"></td>
	  <td align="center"><input type="text" class="car-field1 datepicker" name="startdate[]" /></td>
	  <td align="center"><input type="text" class="car-field1 datepicker" name="enddate[]"  /></td>
   </tr>
  </table>
  </div>
