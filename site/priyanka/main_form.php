<html><head><script type="text/javascript">
	...
	function checkfiles(){
		...
		if(!validateEmail(email)){
			...
			$('.loanblue #loan_amt').css('border','black solid 1px');
			return true;
		}*/
		...
		if(!num_validation(loan_rate_int)){
			...
			$('#loan_error').html('');
			$('.loanblue').css('border','black solid 1px');
			return true;
			//return false;
		}
	}
...
<body>
<form method="post"  name="frm_enquiry" id="frm_enquiry"  enctype="multipart/form-data" onsubmit="return checkfiles();" >
		<div class="form-div">
