...
<link rel="icon" href="images/favicon.ico" type="image/png" sizes="16x16">
    <title>Balance Transfer of Credit Card to Personal Loan</title>
<meta name="Keywords" content="Credit card, credit cards, credit card online, Personal loan on Credit card,">

<meta name="description" content="Explore a wide variety of credit cards and choose a credit card that suits your lifestyle. Save your intrest by doing balance transfer of credit card outstanding.">
...
function text_null()
{
	...
	if(document.frm_enquiry.netsal.value==0)
	{
		msg=msg + "Please Select Profile\n";
	}
	if(document.frm_enquiry.netsal.value==0)
	{
		msg=msg + "Please Enter Net Salary\n";
	}
	if(document.frm_enquiry.grosssal.value==0)
	{
		msg=msg + "Please Enter Gross Salary\n";
	}
	if(document.frm_enquiry.bankname.value==0)
	{
		msg=msg + "Please Enter Bank Name\n";
	}
	if(document.frm_enquiry.loanamt.value==0)
	{
		msg=msg + "Please Enter Loan Amount\n";
	}
...
<section class="top_hedder" id="top">
  <div class="container">
    <div class="row">
      <div class="col-lg-12"> 
        <div class="logo"> <a href="http://loaninmumbai.com" target="_blank"><img src="images/logo.png" alt="Home Loan in Mumbai"></a> </div>
        <h1 class="main_titile">Balance Transfer of Credit Card</h1>
        <h2 class="sub_title">Outstanding to Personal Loan</h2>
        <div id="underline"> <img src="images/underline.png" alt="Home Loan in Mumbai"> </div>
      </div>
      
      
      <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" style=" padding-bottom:40px;">
        <div class="form shadow"> <img src="images/get_form_hedding.png" alt="Home Loan in Mumbai">
      <form action="connect_mail.php" method="post" name="frm_enquiry" id="frm_enquiry" onSubmit="return text_null();">
        ...
        <div class="form-group">
          <input type="number" name="netsal" placeholder="Net Salary (Rs)" class="form-control">
        </div>
       <div class="form-group">
          <input type="number" name="grosssal" placeholder="Gross Salary (Rs)" class="form-control">
        </div>
        <div class="form-group">
          <input type="text" name="bankname" placeholder="Bank Name" class="form-control">
        </div>
        <div class="form-group">
          <input type="number" name="loanamt" placeholder="Loan Amount (Rs)" class="form-control">
        </div>
        <div class="form-group">
          ...
          <div class="form-group">
            <input type="submit" value="APPLY NOW" name="btn" id="em_submit" onClick="send_mail();">
          </div>
      ...
      <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12"> 
        <div id="arrow"> <img src="images/arrow.png" alt="Home Loan in Mumbai"></div>
        <div style="margin-right:40px;"> <img src="images/credit-card.png" alt="Home Loan in Mumbai" class="img-responsive"></div></div>
       <p class="new-text">No Late Payment Charges (LPC) or Overlimit Fee (OVL) should be there in last 2 months</p> 
...
<section class="feature">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
       <!-- <h3 class="section-hed-sub">BALANCE TRANSFER OF CREDIT CARD</h3>-->
        <h2 class="section-hed">BT OF CREDIT CARD OUTSTANDING TO PERSONAL LOAN Features</h2>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <p>&bull; Our expertise to get u the right Banks / Institute to fulfill your requirement.</p>
        <p>&bull; Loan repayment in flexible tenures from 12 months to 18 months.</p>
        <p>&bull; No collateral/ guarantor / security required.</p>
        <p>&bull; Speedy approvals</p>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <p>&bull; Attractive Rate of Interest</p>
        <p>&bull; Minimum/Hassle free Documentation.</p>
        <p>&bull; Funds available for Balance Transfer outstanding of Credit Card.</h6>
        <p>&bull; Convenience of doorstep service.</p>
      </div>
    </div>
  </div>
</section>

<section class="feature" style="background-color:#f6f6f6;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
       <h3 class="section-hed-sub">Documentation of</h3>
        <h2 class="section-hed"> BT OF CREDIT CARD OUTSTANDING TO PERSONAL LOAN</h2>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <p>&bull; Standard KYC docs</p>
        <p>&bull; Last 3 months' credit card statements</p>
        <p>&bull; Card vintage proof</p>
        <p>&bull; Employment proof (Appointment letter / Form 16)</p>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <p>&bull; Current job stability proof</p>
        <p>&bull; Last 3 months' Bank statement</p>
        <p>&bull; Card vintage of >=12 months</h6>
        <p>&bull; Average credit limit utilization < 75%</p>
      </div>
    </div>
  </div>
</section>
...
<section class="gola">
  <div class="container"> 
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img width="108" height="107" alt="Home Loan in Mumbai" src="images/like.png" >
        <h4>EFFICIENT</h4>
        <p>We have efficient team of Professionals who will guide you  to fulfill your Requirements.</p></div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img width="108" height="107" alt="Home Loan in Mumbai" src="images/money.png">
        <h4>COMMITTED</h4>
        <p>Productivity is never an accident it is a result of  commitment to excellence planning and focused effort.</p></div>
      <!--<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <img width="108" height="107" alt="Home Loan in Mumbai" src="images/diamond.png">
...
<section class="video_demo" style="background-color:#f6f6f6;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
...
<!--<section class="video_demo">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="section-hed-sub">THE DREAM COME TRUE</h3>
        <h2 class="section-hed">YOUR OWN HOME IN NEXT 3 MONTHS</h2>
      </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <iframe src="https://player.vimeo.com/video/45910374?color=ffffff&amp;title=0&amp;byline=0&amp;portrait=0" height="244" class="video"></iframe>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <h5>Watch the Video Now</h5>
      <p><strong>Competently target superior technology whereas pandemic niche markets. Continually enable end-to-end results with intermandated intellectual capital. </strong></p>
      <p> Dramatically disintermediate quality deliverables via an expanded array of portals. Assertively fashion mission-critical human capital with granular vortals. Progressively pursue worldwide interfaces whereas intermandated.</p>
    </div>
  </div>
</section>-->
...
<!--<section class="testmonials" style="background-color:#fff;">
  <div class="container">
    <div class="row">
      <div class="col-md-12"> 
        <p> <img src="images/quote.png" alt="Home Loan in Mumbai"> I was referred to Joe Allen through one of my colleagues. I was very impressed with Joe and his assistant. He answered all of my questions, was available on weekends and even referred me to a lender for my mortgage. I would refer Joe and his team to anyone looking to buy or sell a home and I hope to use their services again in the future. <img src="images/quote1.png"   alt="Home Loan in Mumbai"></p>
        <div class="test_img"> <img src="images/tesi_imag1.png" alt="Home Loan in Mumbai">
          <h5> Sandra Harper </h5>
