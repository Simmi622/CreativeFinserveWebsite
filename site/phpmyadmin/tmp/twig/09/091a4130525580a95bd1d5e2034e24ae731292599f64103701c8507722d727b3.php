...
class __TwigTemplate_6b0eb1fb84bec968746df389599711be3f77b513fbc976015dcb4d7e0916c898 extends \Twig\Template
{
...
(isset($context["content"]) ? $context["content"] : null), "class" => "li_switch_dbstats", "url" => ["href" => ("server_databases.php" . PhpMyAdmin\Url::getCommon(["dbstats" => "1"])), "title" => _gettext("Enable statistics")]]];
            // line 78
            echo "    ";
            $this->loadTemplate("list/unordered.twig", "server/databases/databases_footer.twig", 78)->display(twig_to_array(["items" => (isset($context["items"]) ? $context["items"] : null)]));
        }
        // line 80
        echo "</form>
</div>
";
    ...
    {
        return new Source("", "server/databases/databases_footer.twig", "/srv/users/loaninmumbai/apps/loaninmumbai/public/phpmyadmin/templates/server/databases/databases_footer.twig");
    }
}
