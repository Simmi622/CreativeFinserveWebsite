...
<script src="http://jqueryvalidation.org/files/dist/additional-methods.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
           ...
           $(".datepicker").each(function(){  $(this).datepicker({ picker: "<img class='picker' align='middle' src='images/cal.gif' alt=''/>" }); });
...
function addmoreotherLOan(divName){
   ...
   if(no_of_clicks == 0){
    var cnt= $('#no_of_clicks').val() + 1;
      $('.testclass .spare').addClass('datepicker_'+cnt);

      $(".datepicker_"+cnt).each(function(){  $(this).datepicker({ picker: "<img class='picker' align='middle' src='images/cal.gif' alt=''/>" }); });
    }
  /* $(".datepicker_new").each(function(){  $(this).datepicker({ picker: "<img class='picker' align='middle' src='images/cal.gif' alt=''/>" }); });
    alert($('.testclass datepicker_new').hasClass('bbit-dp-input'));
    alert($('.testclass datepicker_new').hasClass('picker'));
    if($('.testclass datepicker_new').hasClass('bbit-dp-input')){
      $('.testclass datepicker_new').hasClass('bbit-dp-input');
    }*/
   }
...
<div id="card_row" style="display: none;">
  ...
  <div id="loan_row" style="display: none;">
    ...
    <td align="center"><input type="text" class="car-field1 spare" name="startdate[]" data-validation="date" data-validation-format="dd/mm/yyyy"/></td>
    <td align="center"><input type="text" class="car-field1 spare" name="enddate[]"  data-validation="date" data-validation-format="dd/mm/yyyy" /></td>
   </tr>
  </table>
  </div>
